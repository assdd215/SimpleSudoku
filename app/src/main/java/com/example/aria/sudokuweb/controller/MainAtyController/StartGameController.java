...
public class StartGameController implements View.OnClickListener{

    private MainView mainView;
    private MainActivity mainActivity;

    public StartGameController(MainActivity mainActivity,MainView mainView){
