...
public class CheckRankController implements View.OnClickListener{

    private MainView mainView;
    private MainActivity mainActivity;

    public CheckRankController(MainActivity mainActivity,MainView mainView){
